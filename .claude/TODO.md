...
- [ ] **Validazione utente v3.5.46** — ricaricare l'estensione e verificare su un annuncio **lungo** (30-40s) che scorra accelerato fino in fondo senza spinner. Serve **una ricarica di pagina in piu'** al primo giro se `__adoff_pro` non e' ancora popolato.
