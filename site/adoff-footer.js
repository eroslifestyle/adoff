(function () {
  ...
  style.textContent = [
    ...
    '.footer__grid--links{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:48px;padding-bottom:32px;border-bottom:1px solid var(--border,#1e1e3a);margin-bottom:24px}',
    ...
    '@media(max-width:768px){',
      ...
      '.footer__grid--links{grid-template-columns:1fr 1fr;gap:28px 24px}',
  ...
  var html = [
    '<div class="footer__inner">',
      '<div class="footer__grid">',
        ...
        '<div class="footer__brand">',
          ...
          '<div class="footer__social">',
            '<a href="/r/repo" target="_blank" rel="noopener" aria-label="GitHub" class="footer__social-link">',
      ...
      // ─── Seconda riga: linking interno SEO (pagine guide/confronti/funzioni) ────
      '<div class="footer__grid footer__grid--links">',

        '<div>',
          '<p class="footer__col-title" data-i18n="footer.col.guides">Guide</p>',
          '<ul class="footer__links">',
            '<li><a href="' + enRoot('how-it-works') + '" data-i18n="footer.howit">Come funziona</a></li>',
        ...
        '<div>',
          '<p class="footer__col-title" data-i18n="footer.col.platforms">Ad blocker per</p>',
          '<ul class="footer__links">',
            '<li><a href="' + enRoot('ad-blocker-chrome') + '" data-i18n="footer.pl.chrome">Ad blocker Chrome</a></li>',
        ...
        '<div>',
          ...
          '<ul class="footer__links">',
            ...
            '<li><a href="' + lp('vs/adblock-plus') + '" data-i18n="footer.vs.abp">AdOff vs AdBlock Plus</a></li>',
            '<li><a href="' + enRoot('best-ad-blocker-2026') + '" data-i18n="footer.best">Migliori Ad Blocker 2026</a></li>',
            '<li><a href="' + enRoot('ublock-origin-alternative') + '" data-i18n="footer.ubalt">Alternativa a uBlock Origin</a></li>',
          '</ul>',
        '</div>',

        '<div>',
          '<p class="footer__col-title" data-i18n="footer.col.features">Funzioni</p>',
          '<ul class="footer__links">',
            '<li><a href="' + enRoot('block-video-ads') + '" data-i18n="footer.feat.video">Bloccare ads video</a></li>',
            '<li><a href="' + enRoot('bypass-anti-adblock') + '" data-i18n="footer.feat.antiadblock">Bypass muri anti-adblock</a></li>',
            '<li><a href="' + enRoot('undetectable-ad-blocker') + '" data-i18n="footer.feat.undetect">Ad blocker non rilevabile</a></li>',
            '<li><a href="' + enRoot('private-ad-blocker') + '" data-i18n="footer.feat.private">Ad blocker privacy</a></li>',
            '<li><a href="' + enRoot('lightweight-ad-blocker') + '" data-i18n="footer.feat.light">Ad blocker leggero</a></li>',
          '</ul>',
        '</div>',
