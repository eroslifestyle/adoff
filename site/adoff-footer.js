      ...
      '<div class="footer__grid">',
        ...
        '<div>',
          ...
          '<ul class="footer__links">',
            ...
            '<li><a href="/' + fq + '#pricing" data-i18n="footer.pricing">Prezzi</a></li>',
        ...
        '<div>',
          ...
          '<ul class="footer__links">',
            '<li><a href="' + enRoot('vs/ublock-origin') + '" data-i18n="footer.vs.ublock">AdOff vs uBlock Origin</a></li>',
            '<li><a href="' + enRoot('vs/adblock-plus') + '" data-i18n="footer.vs.abp">AdOff vs AdBlock Plus</a></li>',
            '<li><a href="' + enRoot('vs/adguard') + '" data-i18n="footer.vs.adguard">AdOff vs AdGuard</a></li>',
          '</ul>',
        '</div>',
        ...
        '<div>',
          ...
          '<ul class="footer__links">',
            ...
            '<li><a href="' + lp('undetectable-ad-blocker') + '" data-i18n="footer.uc1">Undetectable ad blocker</a></li>',
            '<li><a href="' + lp('lightweight-ad-blocker') + '" data-i18n="footer.uc2">Lightweight ad blocker</a></li>',
            '<li><a href="' + lp('manifest-v3-ad-blocker') + '" data-i18n="footer.uc3">Manifest V3 ad blocker</a></li>',
            '<li><a href="' + lp('block-video-ads') + '" data-i18n="footer.uc4">Block video ads</a></li>',
            '<li><a href="' + lp('bypass-anti-adblock') + '" data-i18n="footer.uc5">Bypass anti-adblock</a></li>',
            '<li><a href="' + lp('private-ad-blocker') + '" data-i18n="footer.uc6">Private ad blocker</a></li>',
          '</ul>',
        '</div>',
