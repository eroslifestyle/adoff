(function () {
  ...
  root.innerHTML = [
    '<div class="sn-inner">',
      ...
      '<ul class="sn-links">',
        ...
        '<li>',
          '<a href="/r/repo" class="sn-github" target="_blank" rel="noopener noreferrer" aria-label="GitHub">',
            githubSvg,
            'GitHub',
          '</a>',
        '</li>',
    ...
    '<div class="sn-mobile">',
      ...
      '<a href="' + privacyLink + '" data-i18n="nav.privacy">Privacy</a>',
      '<a href="/r/repo" class="sn-github" target="_blank" rel="noopener noreferrer">',
        githubSvg,
        ' GitHub',
      '</a>',
  ...
  // ─── Translate nav after injection ─────────────────────────────────────────
  if (window.AdOffI18n && window.AdOffI18n.ready) {
    window.AdOffI18n.applyTo(root);
  }
  document.addEventListener('adoff-i18n-ready', function () {
    if (window.AdOffI18n) window.AdOffI18n.applyTo(root);
  });
