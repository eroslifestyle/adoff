(function () {
  ...
  function detectReviewUrl() {
    ...
    // ID PUBBLICO dell'estensione sullo store (NON chrome.runtime.id: nell'unpacked
    // dev è un ID diverso → link a un'estensione inesistente. Hardcoded come l'ID
    // Edge e lo slug AMO qui sopra). Chrome + Opera usano lo stesso store CWS.
    return "https://chromewebstore.google.com/detail/fcjfpfhdcpbjmihiikbblcokmjnhedhp/reviews";
  }
  ...
  // Link recensione sempre disponibile → store del browser in uso (detectReviewUrl).
