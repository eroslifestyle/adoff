...
>
> **Chrome Web Store** ed **Edge Add-ons** vanno compilati a mano dal pannello.

---

## Chrome Web Store

**Dove:** [Developer Dashboard](https://chrome.google.com/webstore/devconsole) > La tua estensione > **Store listing**

**Campi:** Summary + Description per en-US e it
...
**Dove:** [Partner Center](https://partner.microsoft.com/dashboard) > La tua estensione > **Store listing** > Seleziona lingua

**Lingue:** English (en-us), German (de), Spanish (es-es), French (fr), Italian (it-it), Portuguese (pt-br)

Inserisci gli stessi testi riportati sopra per la lingua corrispondente (Summary + Description).

---

## Cosa e' cambiato

- **Numero regole:** 138 -> **153**
- Eliminate le diciture **(Pro)** dalle funzioni
- Eliminata la sezione **FREE vs PRO**
